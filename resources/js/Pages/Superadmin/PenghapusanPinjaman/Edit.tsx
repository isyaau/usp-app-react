...
export default function Edit({ transaksi, kantors }: Props) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Penghapusan — ${transaksi.no_transaksi}`} />
            <PageHeader
                title={`Edit Penghapusan — ${transaksi.no_transaksi}`}
            ...
            <Card className="max-w-3xl">
                <CardHeader>
                    <CardTitle>Edit Penghapusan Pinjaman</CardTitle>
                    <CardDescription>Perbarui data penghapusan (hapus buku) pinjaman.</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label>Sisa Pokok Dihapus</Label>

...
export default function Create({ kelompoks, kantors }: Props) {
    ...
    const base = 'superadmin.transaksi-pinjaman.setoran-angsuran-custom';

    return (
        <AuthenticatedLayout>
            <Head title="Tambah Setoran Angsuran Custom" />
            <PageHeader
                title="Tambah Setoran Angsuran Custom"
            ...
            <form onSubmit={submit} className="max-w-5xl space-y-4">
                <Card>
                    <CardHeader>
                        <CardTitle>Form Setoran Angsuran Custom</CardTitle>

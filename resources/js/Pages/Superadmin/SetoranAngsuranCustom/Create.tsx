...
export default function Create({ kelompoks, kantors }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        setData('details', details);
        post(route('superadmin.transaksi-pinjaman.setoran-angsuran-custom.store'));
    };
    ...
    return (
        <AuthenticatedLayout>
            <PageHeader title="Tambah Setoran Simpanan & Angsuran Custom" />
            <div className="max-w-5xl mx-auto p-6">
                <form onSubmit={submit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            <CardTitle>Form Setoran Simpanan & Angsuran Custom</CardTitle>
                    ...
                    <div className="flex justify-end gap-3">
                        <Button type="button" variant="outline" onClick={() => router.get(route('setoran-angsuran-custom:setoran-angsuran-custom'))}>Batal</Button>

...
export default function BilyetBerjangka({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Bilyet Simpanan Berjangka'} />
            <PageHeader title={variantTitle || 'Bilyet Simpanan Berjangka'} description="Daftar bilyet simpanan berjangka." icon={ScrollText} />

            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.bilyet-berjangka"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.bilyet-berjangka.cetak"
                    />
                </div>

...
export default function NominatifBerjangka({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Nominatif Simpanan Berjangka'} />
            <PageHeader title={variantTitle || 'Laporan Nominatif Simpanan Berjangka'} description="Laporan nominatif simpanan berjangka per anggota." icon={Users} />

            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.nominatif-berjangka"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.nominatif-berjangka.cetak"
                    />
                </div>

...
export default function BagiHasilBerjangka2({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Bagi Hasil Simpanan Berjangka 2'} />
            <PageHeader title={variantTitle || 'Laporan Bagi Hasil Simpanan Berjangka 2'} description="Perhitungan bagi hasil simpanan berjangka (versi 2)." icon={Percent} />

            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.bagi-hasil-berjangka-2"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        showDateRange
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.bagi-hasil-berjangka-2.cetak"
                    />
                </div>

...
export default function DaftarBerjangka({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Daftar Simpanan Berjangka'} />

            <PageHeader title={variantTitle || 'Daftar Simpanan Berjangka'} description="Daftar seluruh simpanan berjangka." icon={List} />

            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.daftar-berjangka"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.daftar-berjangka.cetak"
                    />
                </div>

...
export default function KonfirmasiPerubahanBagiHasil({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Konfirmasi Perubahan Bagi Hasil Simpanan Berjangka'} />
            <PageHeader
                title={variantTitle || 'Konfirmasi Perubahan Bagi Hasil Simpanan Berjangka'}
                description="Konfirmasi perubahan bagi hasil simpanan berjangka."
                icon={FileClock}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.konfirmasi-perubahan-bagi-hasil"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.konfirmasi-perubahan-bagi-hasil.cetak"
                    />
                </div>

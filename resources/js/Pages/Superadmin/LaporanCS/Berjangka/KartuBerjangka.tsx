...
export default function KartuBerjangka({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Kartu Simpanan Berjangka'} />
            <PageHeader title={variantTitle || 'Kartu Simpanan Berjangka'} description="Kartu simpanan berjangka per anggota." icon={CreditCard} />

            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan-berjangka.kartu-berjangka"
                        filters={filters}
                        kantors={kantors}
                        showKantor
                        printRoute="superadmin.laporan-cs.simpanan-berjangka.kartu-berjangka.cetak"
                    />
                </div>

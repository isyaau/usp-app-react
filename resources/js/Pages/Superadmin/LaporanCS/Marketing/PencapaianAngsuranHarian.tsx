...
export default function PencapaianAngsuranHarian({ data, filters, kantors, marketings, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Persentase Pencapaian Angsuran Harian'} />
            <PageHeader
                title={variantTitle || 'Laporan Persentase Pencapaian Angsuran Harian'}
                description="Persentase pencapaian angsuran harian per marketing."
                icon={CalendarDays}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.marketing.pencapaian-angsuran-harian"
                        filters={filters}
                        kantors={kantors}
                        ...
                        showKantor
                        showDateRange
                        printRoute="superadmin.laporan-cs.marketing.pencapaian-angsuran-harian.cetak"
                    />
                </div>

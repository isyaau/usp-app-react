...
export default function AngsuranPinjamanMarketing({ data, filters, kantors, marketings, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Angsuran Pinjaman Marketing'} />
            <PageHeader
                title={variantTitle || 'Laporan Angsuran Pinjaman Marketing'}
                description="Angsuran pinjaman berdasarkan marketing."
                icon={HandCoins}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.marketing.angsuran-pinjaman-marketing"
                        filters={filters}
                        kantors={kantors}
                        ...
                        showKantor
                        showDateRange
                        printRoute="superadmin.laporan-cs.marketing.angsuran-pinjaman-marketing.cetak"
                    />
                </div>

...
export default function PencapaianAngsuranMingguan({ data, filters, kantors, marketings, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Persentase Pencapaian Angsuran Mingguan'} />
            <PageHeader
                title={variantTitle || 'Laporan Persentase Pencapaian Angsuran Mingguan'}
                description="Persentase pencapaian angsuran mingguan per marketing."
                icon={CalendarRange}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.marketing.pencapaian-angsuran-mingguan"
                        filters={filters}
                        kantors={kantors}
                        ...
                        showKantor
                        showDateRange
                        printRoute="superadmin.laporan-cs.marketing.pencapaian-angsuran-mingguan.cetak"
                    />
                </div>

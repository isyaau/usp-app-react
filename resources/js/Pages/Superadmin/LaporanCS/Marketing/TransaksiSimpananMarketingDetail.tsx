...
export default function TransaksiSimpananMarketingDetail({ data, filters, kantors, marketings, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Transaksi Simpanan Marketing Detail'} />
            <PageHeader
                title={variantTitle || 'Laporan Transaksi Simpanan Marketing Detail'}
                description="Detail transaksi simpanan berdasarkan marketing."
                icon={ArrowDownUp}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.marketing.transaksi-simpanan-marketing-detail"
                        filters={filters}
                        kantors={kantors}
                        ...
                        showKantor
                        showDateRange
                        printRoute="superadmin.laporan-cs.marketing.transaksi-simpanan-marketing-detail.cetak"
                    />
                </div>
                        ...
                        <TableBody>
                            ...
                            {data.data.map((item, i) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="text-right tabular-nums">{fmt(item.nominal_tarik)}</TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
                    </Table>

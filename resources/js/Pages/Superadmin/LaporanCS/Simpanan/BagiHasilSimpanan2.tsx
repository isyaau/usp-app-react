...
export default function BagiHasilSimpanan2({ data, filters, kantors, jenisList, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Bagi Hasil Simpanan 2'} />

            <PageHeader
                title={variantTitle || 'Bagi Hasil Simpanan 2'}
                description="Perhitungan bagi hasil simpanan anggota (versi 2)."
                icon={TrendingUp}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan.bagi-hasil-simpanan-2"
                        filters={filters}
                        kantors={kantors}
                        jenisList={jenisList}
                        showKantor
                        showJenis
                        showDateRange
                        printRoute="superadmin.laporan-cs.simpanan.bagi-hasil-simpanan-2.cetak"
                    />
                </div>

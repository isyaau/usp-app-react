...
export default function NominatifSimpanan({ data, filters, kantors, jenisList, kelompoks, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Nominatif Simpanan'} />

            <PageHeader
                title={variantTitle || 'Nominatif Simpanan'}
                description="Daftar nominatif simpanan anggota."
                icon={Users}
            />
            ...
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.simpanan.nominatif-simpanan"
                        filters={filters}
                        kantors={kantors}
                        kelompoks={kelompoks}
                        showKantor
                        showKelompok
                        printRoute="superadmin.laporan-cs.simpanan.nominatif-simpanan.cetak"
                    />
                </div>

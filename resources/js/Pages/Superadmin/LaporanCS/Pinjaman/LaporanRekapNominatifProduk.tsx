...
export default function LaporanRekapNominatifProduk({ data, filters, kantors, jenisList, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Rekap Nominatif Produk'} />
            <PageHeader title={variantTitle || 'Laporan Rekap Nominatif Produk'} description="Laporan rekapitulasi nominatif berdasarkan produk." icon={Package} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.rekap-produk"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        jenisList={jenisList}
                        printRoute="superadmin.laporan-cs.pinjaman.rekap-produk.cetak"
                    />
                </div>

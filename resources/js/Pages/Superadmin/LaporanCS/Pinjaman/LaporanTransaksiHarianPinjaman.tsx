...
export default function LaporanTransaksiHarianPinjaman({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Transaksi Harian Pinjaman'} />
            <PageHeader title={variantTitle || 'Laporan Transaksi Harian Pinjaman'} description="Laporan transaksi harian pinjaman." icon={Calendar} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.harian"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.harian.cetak"
                    />
                </div>

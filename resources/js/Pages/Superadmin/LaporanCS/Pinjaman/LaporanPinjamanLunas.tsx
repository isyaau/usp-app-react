...
export default function LaporanPinjamanLunas({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Pinjaman Lunas'} />
            <PageHeader title={variantTitle || 'Laporan Pinjaman Lunas'} description="Laporan pinjaman yang telah lunas." icon={CheckCircle} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.lunas"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.lunas.cetak"
                    />
                </div>

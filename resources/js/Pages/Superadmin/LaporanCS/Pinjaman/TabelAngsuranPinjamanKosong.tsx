...
export default function TabelAngsuranPinjamanKosong({ data, filters, jenisList, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Tabel Angsuran Pinjaman Kosong'} />
            <PageHeader title={variantTitle || 'Tabel Angsuran Pinjaman Kosong'} description="Tabel angsuran pinjaman kosong." icon={Table} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.tabel-angsuran-kosong"
                        filters={filters}
                        printRoute="superadmin.laporan-cs.pinjaman.tabel-angsuran-kosong.cetak"
                    />
                </div>

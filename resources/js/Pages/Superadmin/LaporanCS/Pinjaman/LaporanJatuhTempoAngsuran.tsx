...
export default function LaporanJatuhTempoAngsuran({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Jatuh Tempo Angsuran'} />
            <PageHeader title={variantTitle || 'Laporan Jatuh Tempo Angsuran'} description="Laporan jatuh tempo angsuran pinjaman." icon={Clock} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.jatuh-tempo-angsuran"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.jatuh-tempo-angsuran.cetak"
                    />
                </div>

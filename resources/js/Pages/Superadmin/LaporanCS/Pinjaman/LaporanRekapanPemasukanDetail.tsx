...
export default function LaporanRekapanPemasukanDetail({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Rekapan Pemasukan Detail'} />
            <PageHeader title={variantTitle || 'Laporan Rekapan Pemasukan Detail'} description="Laporan rekapan pemasukan detail." icon={FileSpreadsheet} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.rekapan-pemasukan"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.rekapan-pemasukan.cetak"
                    />
                </div>

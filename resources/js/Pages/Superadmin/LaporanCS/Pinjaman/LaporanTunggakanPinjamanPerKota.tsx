...
export default function LaporanTunggakanPinjamanPerKota({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Tunggakan Pinjaman Per Kota'} />
            <PageHeader title={variantTitle || 'Laporan Tunggakan Pinjaman Per Kota'} description="Laporan tunggakan pinjaman per kota." icon={MapPin} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.tunggakan-per-kota"
                        filters={filters}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.tunggakan-per-kota.cetak"
                    />
                </div>

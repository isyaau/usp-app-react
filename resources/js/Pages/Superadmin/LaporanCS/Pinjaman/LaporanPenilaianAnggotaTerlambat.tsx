...
export default function LaporanPenilaianAnggotaTerlambat({ data, filters, kelompoks, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Penilaian Anggota Terlambat'} />
            <PageHeader title={variantTitle || 'Laporan Penilaian Anggota Terlambat'} description="Laporan penilaian anggota terlambat." icon={AlertTriangle} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.penilaian-terlambat"
                        filters={filters}
                        showDateRange={true}
                        kelompoks={kelompoks}
                        showKelompok={true}
                        printRoute="superadmin.laporan-cs.pinjaman.penilaian-terlambat.cetak"
                    />
                </div>

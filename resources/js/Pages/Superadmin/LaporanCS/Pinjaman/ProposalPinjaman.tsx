...
export default function ProposalPinjaman({ data, filters, kantors, jenisList, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Proposal Pinjaman'} />
            <PageHeader title={variantTitle || 'Proposal Pinjaman'} description="Daftar proposal pinjaman." icon={FileText} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.proposal"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.proposal.cetak"
                    />
                </div>

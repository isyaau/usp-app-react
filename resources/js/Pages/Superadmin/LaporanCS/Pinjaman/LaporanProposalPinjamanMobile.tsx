...
export default function LaporanProposalPinjamanMobile({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Proposal Pinjaman Mobile'} />
            <PageHeader title={variantTitle || 'Laporan Proposal Pinjaman Mobile'} description="Daftar proposal pinjaman dari mobile." icon={Smartphone} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.proposal-mobile"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.proposal-mobile.cetak"
                    />
                </div>

...
export default function TransaksiPinjaman({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Transaksi Pinjaman'} />
            <PageHeader title={variantTitle || 'Transaksi Pinjaman'} description="Laporan transaksi pinjaman." icon={ArrowRightLeft} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.transaksi"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.transaksi.cetak"
                    />
                </div>

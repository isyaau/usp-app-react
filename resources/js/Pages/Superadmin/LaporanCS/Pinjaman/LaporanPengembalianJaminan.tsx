...
export default function LaporanPengembalianJaminan({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Pengembalian Jaminan'} />
            <PageHeader title={variantTitle || 'Laporan Pengembalian Jaminan'} description="Laporan pengembalian jaminan pinjaman." icon={Shield} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.pengembalian-jaminan"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.pengembalian-jaminan.cetak"
                    />
                </div>

...
export default function LaporanNominatifDenda({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Nominatif Denda'} />
            <PageHeader title={variantTitle || 'Laporan Nominatif Denda'} description="Laporan nominatif denda pinjaman." icon={AlertTriangle} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.nominatif-denda"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.nominatif-denda.cetak"
                    />
                </div>

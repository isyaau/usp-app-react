...
export default function RekapitulasiPinjamanSektor({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Rekapitulasi Pinjaman Sektor'} />
            <PageHeader title={variantTitle || 'Rekapitulasi Pinjaman Sektor'} description="Rekapitulasi pinjaman berdasarkan sektor." icon={Building} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.rekapitulasi-sektor"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.rekapitulasi-sektor.cetak"
                    />
                </div>

...
export default function RekapitulasiPinjaman({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Rekapitulasi Pinjaman'} />
            <PageHeader title={variantTitle || 'Rekapitulasi Pinjaman'} description="Rekapitulasi data pinjaman." icon={BarChart3} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.rekapitulasi"
                        filters={filters}
                        showDateRange={true}
                        showKantor={true}
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.rekapitulasi.cetak"
                    />
                </div>

...
export default function LaporanPinjamanJatuhTempo({ data, filters, kantors, variantTitle }: Props) {
    return (
        <AuthenticatedLayout>
            <Head title={variantTitle || 'Laporan Pinjaman Jatuh Tempo'} />
            <PageHeader title={variantTitle || 'Laporan Pinjaman Jatuh Tempo'} description="Laporan pinjaman jatuh tempo." icon={Clock} />
            <Card className="gap-4 py-5">
                <div className="px-5">
                    <ReportFilterBar
                        routeName="superadmin.laporan-cs.pinjaman.jatuh-tempo"
                        filters={filters}
                        showDateRange
                        showKantor
                        kantors={kantors}
                        printRoute="superadmin.laporan-cs.pinjaman.jatuh-tempo.cetak"
                    />
                </div>

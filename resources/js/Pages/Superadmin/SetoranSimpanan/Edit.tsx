...
export default function Edit({
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.put(
            route('superadmin.transaksi-simpanan.setoran-simpanan.update', {
                setoranSimpanan: transaksiData.id,
            }),
        );
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Edit Setoran Simpanan" />

            <PageHeader
                title="Edit Setoran Simpanan"
                description="Perbarui data transaksi setoran."
                icon={ArrowDownToLine}
                backHref={route(
                    'superadmin.transaksi-simpanan.setoran-simpanan',
                )}
            />

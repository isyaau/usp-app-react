        ...
        <AuthenticatedLayout>
            ...
            >
                <Button asChild className="bg-brand-600 hover:bg-brand-500">
                    <a href={route('superadmin.pinjaman.jaminan.create')}>
                        <Plus />
                        Tambah Jaminan
                    </a>
                </Button>
                                    ...
                                    <TableCell>
                                        <div className="flex items-center justify-end gap-1">
                                            <Button variant="ghost" size="icon" className="size-8" asChild>
                                                <a href={route('superadmin.pinjaman.jaminan.show', item.id)} aria-label={`Lihat ${item.nama}`}>
                                                    <Eye className="size-4" />
                                                </a>
                                            </Button>
                                            <Button variant="ghost" size="icon" className="size-8" asChild>
                                                <a href={route('superadmin.pinjaman.jaminan.edit', item.id)} aria-label={`Edit ${item.nama}`}>

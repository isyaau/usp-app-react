...
import type { RencanaFormValues, RencanaRow, RekeningOption } from '@/types/models';
...
export default function SimpananRencanaEdit({
    rencanaData,
    kantorOptions,
    rekeningOptions,
}: Props) {
    const form = useForm<RencanaFormValues>({
        tanggal_mulai: rencanaData.tanggal_mulai,
        tanggal_jatuhtempo: rencanaData.tanggal_jatuhtempo,
        no_bukti: rencanaData.no_bukti,
        jangka_waktu: rencanaData.jangka_waktu,
        satuan: rencanaData.satuan,
        nominal: rencanaData.nominal,
        bunga: rencanaData.bunga,
        keterangan: rencanaData.keterangan ?? '',
        kantor_id: String(rencanaData.kantor_id),
        simpanan_ids: rencanaData.simpanan_ids ?? [],
    });

    // Modal pemilih rekening.
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.put(route('superadmin.simpanan.rencana.update', rencanaData.id), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Edit Simpanan Rencana" />

            <PageHeader
                title="Edit Simpanan Rencana"
                description="Perbarui rencana simpanan dan rekening yang terlibat."
                icon={CalendarClock}

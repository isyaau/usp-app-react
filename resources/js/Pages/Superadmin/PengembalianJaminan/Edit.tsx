...
export default function Edit({ transaksi, kantors }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        sisa_pokok: String(transaksi.sisa_pokok ?? ''),
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Pengembalian Jaminan — ${transaksi.no_transaksi}`} />
            <PageHeader
                title={`Edit Pengembalian Jaminan — ${transaksi.no_transaksi}`}
            ...
            <Card className="max-w-3xl">
                <CardHeader>
                    <CardTitle>Edit Pengembalian Jaminan</CardTitle>
                    <CardDescription>Perbarui data pengembalian jaminan.</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input type="number" min="0" step="any" value={data.sisa_pokok} onChange={(e) => setData('sisa_pokok', e.target.value)} />

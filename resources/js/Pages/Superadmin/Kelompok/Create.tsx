...
/**
 * Combobox pencarian ketua — replikasi perilaku dropdown Livewire lama,
 * kini dengan debounce + fetch ke endpoint search-users.
 */
...
interface Props {
    initialKetua?: UserOption | null;
}

export default function KelompokCreate({ initialKetua = null }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        form.post(route('superadmin.kelompok.store'));
    };
    ...
    return (
        <AuthenticatedLayout>
            ...
            <PageHeader
                ...
                description="Daftarkan kelompok anggota baru."
                icon={Users}
                    ...
                    <CardContent className="space-y-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <KetuaCombobox
                                ...
                                initialLabel={initialKetua?.nama}
                            />
                        </div>
                    </CardContent>
                </Card>

...
export default function Create({ kelompoks, kantors, jenis: initJenis, metode: initMetode }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        setData('details', details);
        post(route('superadmin.transaksi-pinjaman.angsuran-kolektif.store'));
    };
    ...
    return (
        <AuthenticatedLayout>
            <PageHeader title="Tambah Angsuran Kolektif" />

...
const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        icon: Users,
        children: [
            { label: 'Daftar Marketing', route: 'superadmin.laporan-cs.marketing.daftar-marketing' },
            { label: 'Angsuran Pinjaman Marketing', route: 'superadmin.laporan-cs.marketing.angsuran-pinjaman-marketing' },
            { label: 'Angsuran Pinjaman Marketing Detail', route: 'superadmin.laporan-cs.marketing.angsuran-pinjaman-marketing-detail' },
            { label: 'Insentif Marketing', route: 'superadmin.laporan-cs.marketing.insentif-marketing' },
            { label: 'Insentif Marketing Angsuran Pinjaman', route: 'superadmin.laporan-cs.marketing.insentif-marketing-angsuran-pinjaman' },
            { label: 'Pinjaman Marketing', route: 'superadmin.laporan-cs.marketing.pinjaman-marketing' },
            { label: 'Tagihan Marketing', route: 'superadmin.laporan-cs.marketing.tagihan-marketing' },
            { label: 'Tagihan Marketing Detail', route: 'superadmin.laporan-cs.marketing.tagihan-marketing-detail' },
            { label: 'Tagihan Marketing (Status)', route: 'superadmin.laporan-cs.marketing.tagihan-marketing-status' },
            { label: 'Simpanan Marketing', route: 'superadmin.laporan-cs.marketing.simpanan-marketing' },
            { label: 'Transaksi Simpanan Marketing', route: 'superadmin.laporan-cs.marketing.transaksi-simpanan-marketing' },
            { label: 'Transaksi Simpanan Marketing Detail', route: 'superadmin.laporan-cs.marketing.transaksi-simpanan-marketing-detail' },
            { label: 'NPL Marketing', route: 'superadmin.laporan-cs.marketing.npl-marketing' },
            { label: 'Persentase Pencapaian Angsuran Harian', route: 'superadmin.laporan-cs.marketing.pencapaian-angsuran-harian' },
            { label: 'Persentase Pencapaian Angsuran Mingguan', route: 'superadmin.laporan-cs.marketing.pencapaian-angsuran-mingguan' },
            { label: 'Persentase Pencapaian Angsuran Bulanan', route: 'superadmin.laporan-cs.marketing.pencapaian-angsuran-bulanan' },
            { label: 'Rekapitulasi Pinjaman Marketing', route: 'superadmin.laporan-cs.marketing.rekapitulasi-pinjaman-marketing' },
        ],
    },
    { header: 'Front Office' },
    {

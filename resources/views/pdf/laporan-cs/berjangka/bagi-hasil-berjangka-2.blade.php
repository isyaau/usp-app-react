...
<body>
    ...
    <div class="content">
        <h2>Laporan Bagi Hasil Simpanan Berjangka 2</h2>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">Rp {{ number_format($rate ? round(($item->nominal ?? 0) * $rate / 100) : 0, 0, ',', '.') }}</td>
                </tr>
                @empty

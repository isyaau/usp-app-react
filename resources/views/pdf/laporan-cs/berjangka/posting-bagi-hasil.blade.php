...
<body>
    ...
    <div class="content">
        <h2>Laporan Posting Bagi Hasil Simpanan Berjangka</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:9%;">Jangka</th>
                    <th style="width:7%;">Bunga</th>
                    <th style="width:13%;">Nominal</th>
                    <th style="width:14%;">Status Bagi Hasil</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ ($item->bunga_accrual ?? 0) ? 'Sudah Diposting' : 'Belum Diposting' }}</td>
                </tr>
                @empty

...
<body>
    ...
    <div class="content">
        <h2>{{ $variantTitle ?? 'Bagi Hasil Simpanan (Variant 2)' }}</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:17%;">Perhitungan Bunga</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;">Rp {{ number_format($item->saldo ?? 0, 0, ',', '.') }}</td>
                    <td style="text-align:center;">{{ $item->perhitungan_bunga ?? '—' }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item->bagi_hasil ?? 0, 0, ',', '.') }}</td>

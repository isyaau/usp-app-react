...
<body>
    ...
    <div class="content">
        <h2>{{ $variantTitle ?? 'Tunggakan Setoran Wajib' }}</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:12%;">Tunggakan (Bulan)</th>
                    <th style="width:16%;">Nominal Tunggakan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ $item->tunggakan_bulan ?? 0 }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item->nominal_tunggakan ?? 0, 0, ',', '.') }}</td>

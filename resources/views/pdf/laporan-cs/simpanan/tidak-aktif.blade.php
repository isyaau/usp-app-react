...
<body>
    ...
    <div class="content">
        <h2>{{ $variantTitle ?? 'Simpanan Tidak Aktif' }}</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:16%;">Tanggal Aktif Terakhir</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ \Carbon\Carbon::parse($item->tanggal_aktif_terakhir)->format('d/m/Y') ?? '—' }}</td>

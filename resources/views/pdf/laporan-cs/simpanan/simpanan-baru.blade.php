...
<body>
    ...
    <div class="content">
        <h2>{{ $variantTitle ?? 'Simpanan Baru' }}</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:12%;">Tanggal Buka</th>
                    <th style="width:10%;">No Anggota</th>
                    <th style="width:18%;">Nama Anggota</th>
                    <th style="width:16%;">Jenis Simpanan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ \Carbon\Carbon::parse($item->tanggal_buka)->format('d/m/Y') ?? '—' }}</td>

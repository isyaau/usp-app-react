...
<body>
    ...
    <div class="content">
        <h2>Laporan Transaksi Simpanan Marketing Detail</h2>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->simpanan->no_rekening ?? '—' }}</td>
                    <td>{{ $item->anggota->no_anggota ?? '—' }}</td>
                    <td>{{ $item->anggota->nama ?? '—' }}</td>
                    <td>{{ $item->simpanan->jenis_simpanan->nama ?? '—' }}</td>
                    <td>{{ $item->simpanan->marketing->nama ?? '—' }}</td>

        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:11%;">Plafon</th>
                    <th style="width:11%;">Sisa Pokok</th>
                    <th style="width:8%;">Angsuran</th>
                    <th style="width:10%;">Tanggal Tunggakan</th>
                    <th style="width:8%;">Hari Tunggakan</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item['tanggal_tunggakan'] ?? '—' }}</td>
                    <td style="text-align:center;">{{ $item['hari_tunggakan'] ?? 0 }}</td>

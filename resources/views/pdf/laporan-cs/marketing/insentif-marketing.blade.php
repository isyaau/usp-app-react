...
<body>
    ...
    <div class="content">
        <h2>Laporan Insentif Marketing</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:13%;">Total Angsuran</th>
                    <th style="width:13%;">Pokok</th>
                    <th style="width:13%;">Bunga</th>
                    <th style="width:10%;">% Insentif</th>
                    <th style="width:17%;">Nilai Insentif</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item['kode'] ?? '—' }}</td>
                    <td>{{ $item['nama'] ?? '—' }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item['total_angsuran'] ?? 0, 0, ',', '.') }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item['total_pokok'] ?? 0, 0, ',', '.') }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item['total_bunga'] ?? 0, 0, ',', '.') }}</td>
                    <td style="text-align:center;">{{ $item['rate_insentif'] ?? 0 }}%</td>
                    <td style="text-align:right;">Rp {{ number_format($item['nilai_insentif'] ?? 0, 0, ',', '.') }}</td>
                </tr>
                @empty

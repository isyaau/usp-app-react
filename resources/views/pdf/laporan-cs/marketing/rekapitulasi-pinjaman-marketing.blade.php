...
<body>
    ...
    <div class="content">
        <h2>Rekapitulasi Pinjaman Marketing</h2>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:15%;">Jumlah Pinjaman</th>
                    <th style="width:24%;">Total Plafon</th>
                    <th style="width:22%;">Rata-Rata</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item['kode'] ?? '—' }}</td>
                    <td>{{ $item['nama'] ?? '—' }}</td>
                    <td style="text-align:center;">{{ $item['jumlah_pinjaman'] ?? 0 }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item['total_plafon'] ?? 0, 0, ',', '.') }}</td>
                    <td style="text-align:right;">Rp {{ number_format($item['rata_rata'] ?? 0, 0, ',', '.') }}</td>
                </tr>
                @empty

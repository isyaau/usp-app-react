                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="mb-3 position-relative">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder="Ketik nomor atau nama anggota..."
                                                            wire:model.debounce.300ms="queryAnggota"
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div class="card mb-3 col-6">
                                                <img src="{{ asset($existingSignature) }}" class="card-img-top" alt="Tanda tangan">
                                                <div class="card-body">
                                                    <h5 class="card-title">Tanda Tangan Tersimpan</h5>
                                                </div>
                                            </div>
                                            @else

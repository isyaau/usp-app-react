                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            <label for="kode" class="form-label">
                                                Bayar Tunai <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div class="mb-3">
                                            <label for="kode" class="form-label">
                                                Kas Harian <span class="text-danger">*</span>
                                            </label>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            <label for="kode" class="form-label">
                                                Nominal Cair <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div class="mb-3">
                                            <label for="kode" class="form-label">
                                                Total Cair <span class="text-danger">*</span>
                                            </label>

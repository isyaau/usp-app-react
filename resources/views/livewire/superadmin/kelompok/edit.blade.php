                ...
                <div class="col-md-6 flex-fill">
                    ...
                    <div class="card card-danger card-outline mb-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">Formulir Edit Kelompok</div>
                        </div>
                        ...
                        <form wire:submit.prevent="update">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 position-relative">
                                    <label for="searchUser" class="form-label">Ketua <span class="text-danger">*</span></label>

                                    <input
                                        type="text"
                                        id="searchUser"
                                        class="form-control @error('ketua_id') is-invalid @enderror"

<div class="app-main">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start r gap-2">
                                <a wire:navigate href="/superadmin/kelompok/create" class="col-xl-2 col-md-2 btn btn-sm btn-primary mb-2"><i class="fa-solid fa-plus"></i> Tambah Kelompok</a>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">{{ $kelompok->firstItem() + $loop->index }}</td>
                                            <td>{{ $item->kode }}</td>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->ketua ? $item->ketua->nama : '-' }}</td>
                                            <td class="text-center">
                                                <a wire:navigate href="/superadmin/kelompok/{{ $item->id }}/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a wire:navigate href="/superadmin/kelompok/{{ $item->id }}" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                                <button type="button"
                                                    class="btn btn-sm btn-danger btn-delete-kelompok"
                                                    data-id="{{ $item->id }}">
    ...
    <script>
        ...
        function initDeleteButtons() {
            document.querySelectorAll('.btn-delete-kelompok').forEach(btn => {
                btn.onclick = function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Livewire.dispatch('deleteKelompok', {
                                id: kelompokId
                            });
                        }
                    });

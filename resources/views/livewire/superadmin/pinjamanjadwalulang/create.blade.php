                                ...
                                <div class="tab-content">
                                    ...
                                    <div style="{{ $activeTab === 'pinjaman' ? 'display:block;' : 'display:none;' }}">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="kantor_id" class="form-label">Nomor Pinjaman Lama </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="proposal_id" class="form-label">Nomor Simpanan Wajib Pinjaman </label>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="jenis_id" class="form-label">Sisa Pokok </label>
                                            ...
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label for="jaminan_id" class="form-label">Sisa Bagi Hasil </label>
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label for="jaminan_id" class="form-label">Hitung </label>
                                                            <input wire:model.live="jaminan_id"
                                                                type="text"
                                                                id="jaminan_id"
                                                                class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="angsuran" class="form-label">Plafon </label>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="swp_id" class="form-label">Produk Pinjaman </label>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="plafon" class="form-label">Jaminan </label>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="spp_id" class="form-label">Jenis Angsuran </label>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="periode" class="form-label">Jenis Pembayaran </label>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label for="pembayaran" class="form-label">Jatuh Tempo </label>

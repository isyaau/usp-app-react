                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start r gap-2">
                                <a wire:navigate href="/superadmin/simpanan-berjangka/create" class="col-xl-2 col-md-2 btn btn-sm btn-primary mb-2"><i class="fa-solid fa-plus"></i> Tambah {{ $title }}</a>
                                ...
                                <table class="table table-hover table-bordered">
                                    <thead class="table-danger text-center">
                                        <tr>
                                            ...
                                            <th style="width: 200px">No. Simpanan</th>
                                            <th style="width: 300px">Produk Berjangka</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">{{ $berjangka->firstItem() + $loop->index }}</td>
                                            <td>{{ $item->tanggal }}</td>
                                            ...
                                            <td class="text-center">
                                                <a wire:navigate href="/superadmin/simpanan/produk-simpanan/{{ $item->id }}/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a wire:navigate href="/superadmin/simpanan/produk-simpanan/{{ $item->id }}" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                                <button type="button"
                ...
                btn.onclick = function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Livewire.dispatch('deleteProduk', {
                                id: produkId
                            });
                        }
                    });

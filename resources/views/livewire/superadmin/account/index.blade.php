                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start r gap-2">
                                <a wire:navigate href="/superadmin/account/create" class="col-xl-2 col-md-2 btn btn-sm btn-primary mb-2"><i class="fa-solid fa-plus"></i> Tambah {{ $title }}</a>
                                ...
                                <table class="table table-hover table-bordered">
                                    <thead class="table-danger text-center">
                                        <tr>
                                            ...
                                            <th style="width: 100px">No Account</th>
                                            <th style="width: 300px">Nama Account</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">{{ $account->firstItem() + $loop->index }}</td>
                                            <td>{{ $item->no_account }}</td>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->tipe }}</td>
                                            <td>{{ $item->header ? $item->header->nama : '-' }}</td>
                                            <td class="text-center">
                                                <a wire:navigate href="/superadmin/account/{{ $item->id }}/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a wire:navigate href="/superadmin/account/{{ $item->id }}" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                                <button type="button"

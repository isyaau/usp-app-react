                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start r gap-2">
                                <a wire:navigate href="/superadmin/pinjaman/pinjaman/create" class="col-xl-2 col-md-2 btn btn-sm btn-primary mb-2"><i class="fa-solid fa-plus"></i> Tambah {{ $title }}</a>
                                ...
                                <table class="table table-hover table-bordered">
                                    <thead class="table-danger text-center">
                                        <tr>
                                            ...
                                            <th style="width: 300px">Jatuh Tempo</th>
                                            <th style="width: 300px">No. Pinjaman</th>
                                            <th style="width: 200px">Produk Pinjaman</th>
                                            <th style="width: 200px">Anggota</th>
                                            <th style="width: 100px">Jangka Waktu</th>
                                            <th style="width: 100px">Bagi Hasil</th>
                                            <th style="width: 100px">Plafon</th>
                                            <th style="width: 100px">Angsuran</th>
                                            <th style="width: 100px">Total Pinjaman</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="align-middle">
                                            <td class="text-center">{{ $anggota->firstItem() + $loop->index }}</td>
                                            ...
                                            <td class="text-center">
                                                <a wire:navigate href="/superadmin/anggota/{{ $item->id }}/edit" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                                <a wire:navigate href="/superadmin/anggota/{{ $item->id }}" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                                <button type="button"
                ...
                btn.onclick = function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Livewire.dispatch('deleteAnggota', {
                                id: anggotaId
                            });
                        }
                    });

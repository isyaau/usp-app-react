...
class Index extends Component
{
    ...
    {
        return view('livewire.superadmin.berjangkaproduk.index', [
            'title' => 'Data Produk Simpanan Berjangka',
            'produkberjangka' => DepositoJenis::where('nama', 'LIKE', '%' . $this->search . '%')
                ->orderBy('kode', 'ASC')
                ->paginate($this->paginate),
        ]);
    }

    #[On('deleteBerjangkaproduk')]
    public function deleteBerjangkaproduk($id)
    {
        $berjanjgkaproduk = DepositoJenis::findOrFail($id);

        $berjanjgkaproduk->delete();

...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.superadmin.simpananrencana.index', [
            'title' => 'Data Simpanan Rencana',
            'rencana' => SimpananRencana::where('no_bukti', 'LIKE', $searchTerm)
    ...
    {
        // Cari rencana, abort jika tidak ditemukan
        $rencana = SimpananRencana::with('details')->find($id);

        if (!$rencana) {
            $this->dispatch('kosongSwal');
            return;
        }

        // Hapus detail terkait (jika ada)
        if ($rencana->details()->exists()) {

...
class Index extends Component
{
    ...
    {
        return view('livewire.superadmin.kodetransaksi.index', [
            'title' => 'Data Kode Transaksi',
            'simpanan_kode' => SimpananKode::where('nama', 'LIKE', '%' . $this->search . '%')
                ->orderBy('kode', 'ASC')
    ...
    {
        $simpanan_kode = SimpananKode::findOrFail($id);

        $simpanan_kode->delete();
